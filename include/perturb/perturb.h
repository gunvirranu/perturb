...
enum perturb_GravityModel {
    PERTURB_GRAVITY_MODEL_WGS72_OLD,
    PERTURB_GRAVITY_MODEL_WGS72,
    PERTURB_GRAVITY_MODEL_WGS84
};
...
struct perturb_StateVector {
    struct perturb_JulianDate epoch;   ///< Time-stamp of the state vector
...
struct perturb_OrbitalElements {
...
struct perturb_JulianDate perturb_datetime_to_julian(struct perturb_DateTime t);
struct perturb_DateTime perturb_julian_to_datetime(struct perturb_JulianDate jd);

struct perturb_JulianDate perturb_julian_normalized(struct perturb_JulianDate t);
struct perturb_JulianDate perturb_julian_add_days(
    struct perturb_JulianDate t, perturb_real_t days
);
perturb_real_t perturb_julian_subtract(
    struct perturb_JulianDate lhs, struct perturb_JulianDate rhs
);

struct perturb_OrbitalElements perturb_state_vector_to_orbital_elements(struct perturb_StateVector sv);
